...
public class CrearQuinielaGUI extends JFrame {
	...
	private final JButton btnCrearQuiniela = new JButton("CrearQuinielaGUI.btnApostar.text");  //$NON-NLS-1$ //$NON-NLS-2$
	...
	public CrearQuinielaGUI(User u)
	{
		this.user=u;
	...
	private void jbInit() throws Exception
	{
		...
		this.setSize(new Dimension(957, 500));
		this.setTitle("Crear Quiniela"); //$NON-NLS-1$ //$NON-NLS-2$
		...
		btnCrearQuiniela.setBounds(767, 423, 101, 23);
		getContentPane().add(btnCrearQuiniela);
		
		JButton btnAnadirEvento = new JButton("Anadir Evento"); //$NON-NLS-1$ //$NON-NLS-2$
		btnAnadirEvento.setBounds(491, 295, 118, 23);
		getContentPane().add(btnAnadirEvento);
	...
	private void jButton3_actionPerformed(ActionEvent e) {
		BLFacade facade=PanelAdminGUI.getBusinessLogic();
		if(listaeventos.size()==15) {
			facade.meterQuiniela(listaeventos);
		}else {
			lblError.setText("La quiniela debe tener 15 eventos asignados.");
		}
}
	private void jButton4_actionPerformed(ActionEvent e) {
		if(listaeventos.size()<=15) {
			System.out.println(selectedevent);
			listaeventos.add(selectedevent);
		}else {
			lblError.setText("El número de eventos en la quiniela debe ser menos o igual que 15.");
		}
	}
}
